# AI Company Framework — Method Patterns & Detailed Specifications

> Full specifications for AI Company Framework v4.0.0.
> Merged from: ai-company-framework v3.0.0 + ai-company-harness v3.0.0 + reference requirements.
> SKILL.md contains only the index; this file holds all implementation details.
...
|----------|-----------------|
| Standards | "Standard", "Convention", "Naming", "Schema", "Compliance audit" |
...
| Harness | "Harness check", "L1-L6", "Standard check" |
...
| Templates | "Code template", "Method pattern", "Validation", "Sanitize", "Retry" |
| Prompts | "Prompt template", "CRISPE", "3WEH", "Five-Element" |
| Compliance | "VirusTotal", "ClawHub review", "Security check", "AIGC label", "Robustness" |
...
- **Scope**: All infrastructure, standards, engineering compliance, code templates, prompt frameworks, and security verification for AI-Company skills
- **Role**: Foundation layer — enables all other skills to operate correctly, safely, and compliantly
...
| Dynamic Code Eval | Invoking eval(), exec(), pickle.load() | Pre-defined function libraries | OWASP |
...
This section contains the complete original ai-company-framework v4.0.0 source content.
...
*Source file: ai-company-framework v4.0.0*
